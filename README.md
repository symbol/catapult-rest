...
| apiNode.tlsClientCertificatePath |   | /api-node-config/cert/node.crt.pem |
| apiNode.tlsClientKeyPath |   | /api-node-config/cert/node.key.pem |
| apiNode.tlsCaCertificatePath| | /api-node-config/cert/ca.cert.pem |
| websocket.mq.host | ZeroMQ connection host. |  127.0.0.1 |
| websocket.mq.port | ZeroMQ connection port. |  127.0.0.1 |
