	...
	describe('block', () => {
		const buffers = {
			blockHeader: Buffer.of(
				...
				0x20, 0x8D, 0xEC, 0x1A, 0x5D, 0xB8, 0x55, 0xFB, 0x7C, 0x3E, 0xA2, 0xC5, 0x11, 0xDD, 0x91, 0xA4, // signerPublicKey
			...
			transaction: Buffer.of(
				...
				0xCA, 0xBD, 0xFA, 0x7E, 0x67, 0x3D, 0xF9, 0x6A, 0x1B, 0x17, 0xAF, 0xF3, 0xD9, 0xB8, 0xFF, 0x15, // signerPublicKey
