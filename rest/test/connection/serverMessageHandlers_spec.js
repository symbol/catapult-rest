...
// 		// Act:
// 		ServerMessageHandler.zmqMessageHandler(codec, emitter)(Buffer.of(0x49, 0x6A, 0xCA, 0x80, 0xE4, 0xD8, 0xF2, 0x9F), blockBuffer, 56, 78, 99, 88);
...
// 		// Act:
// 		ServerMessageHandler.zmqMessageHandler(codec, emitter)(Buffer.of(0x54, 0x79, 0xCE, 0x31, 0xA0, 0x32, 0x48, 0x4D), finalizedBlockBuffer, 99, 88);
...
// 		ServerMessageHandler.zmqMessageHandler(codec, emitter)(Buffer.concat([Buffer.of('a'.charCodeAt(0)), addressBuffer]), transactionBuffer, 44, 55, height, 77, 88, 99);
...
// 		// Act:
// 		ServerMessageHandler.zmqMessageHandler(codec, emitter)(Buffer.concat([Buffer.of('r'.charCodeAt(0)), addressBuffer]), 44, 77, 88, 99);
...
// 		// Act:
// 		ServerMessageHandler.zmqMessageHandler(codec, emitter)(Buffer.concat([Buffer.of('s'.charCodeAt(0)), addressBuffer]), buffer, 99);
